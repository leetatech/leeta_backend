...
// @Failure 401 {object} library.DefaultErrorResponse
// @Failure 400 {object} library.DefaultErrorResponse
// @Router /gas-refill/fees [POST]
func (handler *GasRefillHttpHandler) CreateFees(w http.ResponseWriter, r *http.Request) {
	...
	response, err := handler.GasRefillApplication.FeeQuotation(r.Context(), request)
	if err != nil {
		library.EncodeResult(w, err, http.StatusBadRequest)
		return
	}
...
// @Failure 401 {object} library.DefaultErrorResponse
// @Failure 400 {object} library.DefaultErrorResponse
// @Router /gas-refill/fees [GET]
func (handler *GasRefillHttpHandler) GetFees(w http.ResponseWriter, r *http.Request) {
	response, err := handler.GasRefillApplication.GetFees(r.Context())
	if err != nil {
		library.EncodeResult(w, err, http.StatusBadRequest)
		return
	}
